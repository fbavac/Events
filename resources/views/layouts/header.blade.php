...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="">
    ...
    <nav class="header-navbar navbar navbar-expand-lg align-items-center floating-nav  navbar-light navbar-shadow">
        <div class="navbar-container d-flex content">
            ...
            <div class="user-nav d-sm-flex d-none"><span class="user-name font-weight-bolder">Hello {{Auth::user()->name}}</span></div>
            <ul class="nav navbar-nav align-items-center ml-auto">
                <li class="nav-item dropdown dropdown-user"><a href="{{url('/')}}"><i class="ficon" data-feather="eye"></i>&nbsp<b>Public</b></a></li>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="{{url('home')}}"><span class="brand-logo">
                        ...
                        <h2 style="color:#C45E72" class="brand-text">Test</h2>
                    </a></li>
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" navigation-header"><span data-i18n="Apps &amp; Pages">Here you &amp; Go</span><i data-feather="more-horizontal"></i>
                </li>
                <li class="{{ (request()->is('home')) ? 'active' : '' }} nav-item"><a class="d-flex align-items-center" href="{{ route('home') }}"><i data-feather="home"></i><span class="menu-title text-truncate" data-i18n="Email">Dashboard</span></a></li>
                <li class="{{ (request()->is('event')) ? 'active' : '' }} nav-item"><a class="d-flex align-items-center" href="{{ url('event') }}"><i data-feather="home"></i><span class="menu-title text-truncate" data-i18n="Email">Events</span></a></li>
                <li class="{{ (request()->is('invite')) ? 'active' : '' }} nav-item"><a class="d-flex align-items-center" href="{{ url('invite') }}"><i data-feather="home"></i><span class="menu-title text-truncate" data-i18n="Email">Invite People</span></a></li>
